#kamera görüntüsündeki en büyük konturu belirleyerek üç temel noktasını (sol, sağ, üst) bulur ve bu noktalar arasındaki açıyı hesaplar. Eğer açı 70 dereceden büyükse ekranın köşesine mavi bir kare çizer.
