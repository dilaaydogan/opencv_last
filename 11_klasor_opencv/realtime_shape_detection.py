#Bu kod, kameradan alınan görüntüde belirli bir renk aralığını filtreleyerek, o renk içindeki şekilleri tespit eder ve isimlerini ekrana yazar.
...
while 1:
    ...
    mask = cv2.erode(mask,kernel) #erode fonksiyonu, maskeyi küçültür ve gürültüleri azaltır.
    ...
    for cnt in contours:
        ...
        approx = cv2.approxPolyDP(cnt,epsilon,True) #approxPolyDP, şeklin köşe noktalarını yaklaştırır.
